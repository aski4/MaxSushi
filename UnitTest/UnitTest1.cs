...
namespace UnitTest
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void Can_Filter_Produtcts()
        {
            // Arrange
        ...
        public void Can_Create_Categories()
        {
            ...
            mock.Setup(m => m.Products).Returns(new Product[] {
                ...
                new Product {ProductId = 3, Name = "P3", Category = "Plumbus" },
            ...
            Assert.AreEqual(results[2], "Plumbus");
        }
        ...
        public void Generate_Category_Specific_Product_Count()
        {
            ...
            int res1 = ((ProductsListViewModel)target.List("C1").Model).PagingInfo.TotalItems;
            int res2 = ((ProductsListViewModel)target.List("C2").Model).PagingInfo.TotalItems;
            int res3 = ((ProductsListViewModel)target.List("C3").Model).PagingInfo.TotalItems;
